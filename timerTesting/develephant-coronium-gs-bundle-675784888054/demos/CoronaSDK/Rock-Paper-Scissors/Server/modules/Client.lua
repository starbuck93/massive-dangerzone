...
---Set the player custom data space.
-- @local
function Client:_setPlayerData( data )
	self.player_data = data
end

--- Get the players connection data.
-- Custom data included at connection time.
	...
	local function parseLine()
		...
		return function ( chunk )
		  ...
		  for i = 1, #chunk do
		    ...
		    if c == "\n" then
		      local d = buffer .. chunk:sub( start, i - 1 )
